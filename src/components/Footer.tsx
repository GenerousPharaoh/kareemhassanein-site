    ...
    >
      <div className="relative h-full w-full bg-[#0d1117] flex flex-col justify-center items-center text-center pointer-events-auto overflow-hidden">
        ...
        <div className="relative z-10">
          <h2 className="text-5xl sm:text-7xl md:text-[180px] font-medium tracking-tighter mb-8 md:mb-16 leading-[0.75]">
            Let&apos;s <br /><span className="opacity-40 italic font-light font-serif">talk.</span>
          </h2>
          <Link
            href="/contact"
            className="group inline-flex items-center gap-4 md:gap-8 text-xl sm:text-2xl md:text-5xl font-light border border-white/20 rounded-full px-6 sm:px-8 md:px-12 py-3 sm:py-4 md:py-6 hover:bg-white hover:text-black transition-all duration-500"
          >
            Get in touch
        ...
        <div className="absolute bottom-0 left-0 w-full border-t border-white/5 bg-black/20 backdrop-blur-md">
          <div className="max-w-[1800px] mx-auto px-6 md:px-12 py-8 flex flex-col md:flex-row justify-between items-end gap-8">
            <div>
              <h2 className="text-[40px] sm:text-[60px] md:text-[120px] leading-[0.7] font-bold tracking-tighter opacity-[0.05] select-none pointer-events-none">HASSANEIN</h2>
            </div>
