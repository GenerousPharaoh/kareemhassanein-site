...
export const projects: Project[] = [
  ...
  },
  {
    ...
    gallery: [
      ...
      {
        src: '/images/work/kinetikare-condition-library-2026-09-04b.webp',
        alt: 'KinetiKare condition search, body-region filters, and neck and back condition list',
        ...DESKTOP,
        frame: 'browser',
        url: 'kinetikarephysio.com/conditions',
        title: 'The condition library',
        caption: 'Search, body-region filters, and the relevant condition pages in one view.',
      },
      {
      ...
      {
        src: '/images/work/kinetikare-condition-guide-2026-09-04b.webp',
  ...
  },
  {
    ...
    gallery: [
      ...
      {
        src: '/images/work/wedding-proposal-2026-09-04b.webp',
        alt: 'David and Daria wedding website full-screen Machu Picchu photograph marking the proposal setting',
        ...DESKTOP,
        frame: 'browser',
        url: 'david-daria.com/#machu',
        title: 'Where it began',
        caption: 'A full-screen photograph marks Machu Picchu as the setting of the proposal.',
      },
      {
        src: '/images/work/wedding-travel-2026-09-04b.webp',
      ...
      {
        src: '/images/work/wedding-machu-2026-09-04b.webp',
