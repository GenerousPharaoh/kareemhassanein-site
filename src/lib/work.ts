...
export const projects: Project[] = [
  ...
  },
  {
    ...
    gallery: [
      {
        src: '/images/work/endorphins-home-2026-09.webp',
      ...
      {
        src: '/images/work/endorphins-services-2026-09.webp',
      ...
      {
        src: '/images/work/endorphins-physio-2026-09.webp',
      ...
      {
        src: '/images/work/endorphins-booking-2026-09.webp',
      ...
      {
        src: '/images/work/endorphins-mobile-2026-09.webp',
...
export const wallShots: WallShot[] = [
  ...
  { src: '/images/work/reel-endo-disciplines-2026-09.webp', project: EN, url: 'endorphinshealth.com/services', slug: 'endorphins', label: 'Six disciplines',
    alt: 'Endorphins services page introducing six healthcare disciplines under one roof' },
  ...
  { src: '/images/work/reel-endo-physio-2026-09.webp', project: EN, url: 'endorphinshealth.com/services/physiotherapy', slug: 'endorphins', label: 'Physiotherapy',
  ...
  { src: '/images/work/reel-endo-reviews-2026-09.webp', project: EN, url: 'endorphinshealth.com', slug: 'endorphins', label: 'Patient reviews',
  ...
  { src: '/images/work/reel-endo-booking-2026-09.webp', project: EN, url: 'endorphinshealth.com/book-appointment', slug: 'endorphins', label: 'Booking',
  ...
  { src: '/images/work/reel-endo-massage-2026-09.webp', project: EN, url: 'endorphinshealth.com/services/massage-therapy', slug: 'endorphins', label: 'Massage techniques',
  ...
  { src: '/images/work/reel-endo-home-2026-09.webp', project: EN, url: 'endorphinshealth.com', slug: 'endorphins', label: 'The clinic homepage',
