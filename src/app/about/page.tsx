            ...
            <div className="space-y-8">
              <AnimatedBlock delay={0.5} direction="up">
                ...
                <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
                  I spent years as a physiotherapist. MSc from Robert Gordon, 6,000+ patient sessions, top revenue generator at a busy clinic for three consecutive years. Before that, semi-professional soccer in Scotland and Canada.
                </p>
              </AnimatedBlock>
