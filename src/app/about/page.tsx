...
export default function About() {
  return (
    <main className="pt-24 overflow-hidden relative">
      {/* Identity Hero: Fixed Top Spacing */}
        ...
        <div className="section-container grid lg:grid-cols-[1.3fr_0.7fr] gap-32 items-end">
          <div>
            <ScrollReveal direction="none" className="mb-10">
              <span className="text-[10px] font-bold tracking-[0.4em] uppercase opacity-30">Identity Profile</span>
            </ScrollReveal>
            <h1 className="text-7xl md:text-[140px] font-medium tracking-tighter mb-20 leading-[0.75]">
              Roots <br /> {"&"} <span className="opacity-30 italic font-light">Rationale.</span>
            </h1>
          </div>
          <ScrollReveal direction="right" distance={80} className="relative aspect-square rounded-[3rem] overflow-hidden glass-moonlight p-2 gentle-float mb-12">
            <Image
      ...
      {/* Practitioner vs Architect: Balanced Spacing */}
      <section className="py-40 lg:py-64 border-t border-white/5 bg-white/[0.01]">
        <div className="section-container">
          <div className="grid lg:grid-cols-2 gap-40 items-start">
            ...
            <ScrollReveal direction="up" delay={0.2} className="space-y-16 lg:pt-48 border-l border-white/5 pl-24 ml-auto">
              <div className="flex items-center gap-8">
                <div className="w-12 h-12 rounded-2xl bg-white/[0.02] border border-white/5 flex items-center justify-center">
      ...
      {/* Compact Roadmap: High-Density Readability */}
      <section className="py-40 lg:py-64 relative overflow-hidden border-y border-white/5">
        <div className="section-container">
          <ScrollReveal direction="up" className="mb-40">
            <p className="text-[10px] font-bold tracking-[0.4em] uppercase opacity-30 mb-8">Professional History</p>
            <h2 className="text-7xl md:text-[120px] font-medium tracking-tighter leading-none mb-12">Perspective.</h2>
          </ScrollReveal>

          <div className="space-y-px overflow-hidden rounded-[3rem] border border-white/10 bg-white/[0.01]">
            {roadmap.map((item, i) => (
              <ScrollReveal
                key={item.title}
                direction="none"
                delay={i * 0.1}
                className="grid lg:grid-cols-[1.2fr_2.8fr] gap-12 group p-16 bg-[#10141d] border-b border-white/5 last:border-0 hover:bg-white/[0.02] transition-all duration-1000"
              >
                <div className="space-y-6">
                  <span className="text-[11px] font-bold tracking-widest uppercase italic opacity-40 group-hover:opacity-100 transition-opacity duration-1000">{item.period}</span>
                ...
                <div className="space-y-12">
                  ...
                  <ul className="grid md:grid-cols-2 gap-x-12 gap-y-10">
                    {item.points.map((point) => (
                      ...
                      >
                        <ChevronRight size={20} className="text-foreground opacity-20 mt-1 flex-shrink-0" />
                        {point}
                      </motion.li>
                    ))}
                  </ul>
      ...
      <section className="py-80 lg:py-[20vh] text-center px-6">
        <ScrollReveal direction="up" className="space-y-24">
          <h2 className="text-7xl md:text-[140px] font-medium tracking-tighter mb-24 leading-[0.7] text-balance">
            Build <br /> <span className="opacity-30 italic font-light">The Narrative.</span>
          </h2>
          <a
          ...
          >
            ...
            <Download size={48} className="opacity-20 group-hover:translate-y-4 transition-all duration-1000" />
          </a>
        </ScrollReveal>
      </section>
    </main>
